      ...
      <MDBContainer id="message" className="py-5 my-5 text-center">
        ...
        {this.props.location.pathname === "/about" && (
          <div className="text-left mt-5">
            ...
            <small>
              Verantwortlich für das Unternehmen Naturvertrieb und aller
              Services
            </small>
            <p>
              ...
              9580 Villach
              <br />
              <MDBBtn color="green" href="mailto:egger@naturvertrieb.at">
            ...
            <small>
              Entwickler, aber nicht Eigentümer und Verantwortlicher, der
              Homepage und aller Naturvertrieb Webservices
            </small>
            <p>
